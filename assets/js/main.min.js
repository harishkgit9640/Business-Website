...
$(document).ready(function () {
    ...
    const checkboxes = $('.cookieOpt');
    const declineBtn = $('#cookieDecline');
    const allowBtn = $('#cookieAllow');
    const closeBtn = $('#cookieClose');

    // Show only if no preferences saved
...
let prefs = {
    ...
    closeBtn.on('click', () => {
         checkboxes.each(function () {
            ...
            prefs[key] = $(this).is(':checked') ? true : false;
        });
    ...
    if (saved) {
        checkboxes.each(function () {
            const key = $(this).data('key');
            $(this).prop('checked', saved[key] || false);
        });
    }
    ...
    function savePreferences(allowAll = false) {
        checkboxes.each(function () {
            const key = $(this).data('key');
            prefs[key] = allowAll ? true : $(this).is(':checked');
        });
        localStorage.setItem(storageKey, JSON.stringify(prefs));
        modal.addClass('hidden');
    }
